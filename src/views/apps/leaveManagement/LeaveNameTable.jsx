...
const LeaveNameTable = () => {
  ...
  const confirmDelete = async () => {
    if (deleteId) {
      const result = await leaveNameService.deleteLeaveName(deleteId)
  ...
  return (
    <Card>
      <Typography variant='h3' className='px-7 py-2'>Leave Name</Typography>
      ...
      <Dialog fullWidth open={ModalOpen} maxWidth='sm' scroll='body' sx={{ '& .MuiDialog-paper': { overflow: 'visible' } }}>
        ...
        <DialogTitle variant='h4' className='flex gap-2 flex-col text-center sm:pbs-16 sm:pbe-6 sm:pli-16'>
          <LeaveNameForm setModalOpen={setModalOpen} EditSelectedLeaveType={EditSelectedLeaveType} getLeave={getLeave} />
        </DialogTitle>
      </Dialog>
