...
import LeaveNameForm from '@/components/dialogs/leave-management/LeaveName'
import leaveNameService from '@/services/leave-management/leaveName'
import FixedLeaveForm from '@/components/dialogs/leave-management/FixedLeave'
...
const FixedLeaveTable = () => {
  ...
  const confirmDelete = async () => {
    if (deleteId) {
      const result = await fixedleaveNameService.deletefixedLeaveName(deleteId)
  ...
  return (
    <Card>
      <Typography variant='h3' className='px-7 py-2'>Fixed Leave Name</Typography>
      ...
      <Dialog fullWidth open={ModalOpen} maxWidth='sm' scroll='body' sx={{ '& .MuiDialog-paper': { overflow: 'visible' } }}>
        ...
        <DialogTitle variant='h4' className='flex gap-2 flex-col text-center sm:pbs-16 sm:pbe-6 sm:pli-16'>
          <FixedLeaveForm setModalOpen={setModalOpen} EditSelectedLeaveType={EditSelectedLeaveType} getLeave={getLeave} />
        </DialogTitle>
      </Dialog>
...
export default FixedLeaveTable
