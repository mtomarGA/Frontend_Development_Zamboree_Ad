                    ...
                    <Grid container spacing={4} alignItems="stretch" sx={{ flexGrow: 1 }}>
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <Box sx={{ p: 3, border: '1px solid #e0e0e0', borderRadius: 2, backgroundColor: '#ffffff', boxShadow: '0px 2px 4px rgba(0,0,0,0.05)' }}>
                                ...
                                {/* <ProductImagesDisplay showImages={showImages} productId={productId} /> */}
                                        ...
                                        <Box sx={{ mb: 3 }}>
                                            ...
                                            {/* <Box sx={{ display: 'flex', gap: 2, mb: 2, alignItems: 'center' }}>
                                                ...
                                                >
                                                    ...
                                                    <MenuItem value="specialPrice">Happening Price</MenuItem>
                                                    <MenuItem value="sku">SKU</MenuItem>
                                                    <MenuItem value="stockAvailability">Stock Status</MenuItem>
                                                </CustomTextField>
                                                    ...
                                                    <TableBody>
                                                        {formData.variants.map((variant) => (
                                                            ...
                                                            >
                                                                {/* <TableCell padding="checkbox">
                                                                    <Checkbox
                                                                        checked={selectedVariants.indexOf(variant.id) !== -1}
                                                                        onChange={(event) => handleSelectVariant(event, variant.id)}
                                                                    />
                                                                </TableCell> */}
                                                                <TableCell>
                                                                ...
                                                                <TableCell>
                                                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                                                        ...
                                                                        {/* <CustomTextField
                                                                            select
                                                                            size="small"
                                                                            value={variant.specialPriceType}
                                                                            onChange={(e) => handleVariantChange(variant.id, 'specialPriceType', e.target.value)}
                                                                            sx={{ minWidth: 100 }}
                                                                        >
