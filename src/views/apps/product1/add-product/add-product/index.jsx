...
// import AddProduct from '@/components/dialogs/add-product/index.jsx' // REMOVE THIS IMPORT
...
const AddProductTable = () => {
    ...
    const handleGetProduct1 = async () => {
        const res = await product1Service.getAllProductByBusiness1(businessId)
        console.log(res);
    ...
    const handleEditProduct = data => {
        router.push(`/en/apps/product1/${businessId}/detail?id=${data._id}`);
    }

    const handleAddProduct = () => {
        // Navigate to the add product page
        router.push(`/en/apps/product1/${businessId}/detail`);
    }

    const handleDelete = async( id) => {
        const data = await productService.deleteProduct(businessId,id)
    ...
    const columns = useMemo(
        () => [
            ...
            columnHelper.accessor('status', {
                id: 'product_status', // ✅ ensures uniqueness
                header: 'Status',
                cell: ({ row }) => (
                    <Chip
            ...
            columnHelper.accessor('actions', {
                ...
                cell: ({ row }) => (
                    <div className='flex items-center'>
                        {hasPermission("product_add_update:edit") &&
                            <IconButton onClick={() => handleEditProduct(row.original)} > {/* Call handleEditProduct */}
                                <i className='tabler-edit text-blue-500' />
                            </IconButton>}
                        {hasPermission("product_add_update:delete") &&
    ...
    return (
        <>
            <Card>
                <div className='flex flex-wrap justify-between gap-4 p-6'>
                    ...
                    <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
                        ...
                        {hasPermission("product_add_update:add") &&
                            <Button variant='contained' onClick={handleAddProduct}> {/* Call handleAddProduct */}
                                Add Product
                            </Button>}
                    </div>
            ...
            {/* REMOVE THE MODAL COMPONENT HERE */}
