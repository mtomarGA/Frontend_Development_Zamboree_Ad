...
import ApproveBusinessDetail from '@/components/dialogs/approve-business/index'
...
const ListingApprovalTable = () => {
    ...
    const getAllBusiness = async (req, res) => {
        try {
            const response = await approvalService.getPendingBusiness()
    ...
    //     const res = await manageBusinessService.deleteBusinss(id)
    ...
    const columns = useMemo(
        () => [
            ...
            columnHelper.accessor('status', {
                header: 'Razorpay',
                cell: ({ row }) =>
                    //  console.log(row.original?.RazorpaymentStatus),
                
                    (
                    <Chip
                        label={productStatusObj[row.original.RazorpaymentStatus].title}
                        variant='tonal'
                        color={productStatusObj[row.original.RazorpaymentStatus].color}
                        size='small'
                    />
                )
            }),
    ...
    return (
        <>
            ...
            <ApproveBusinessDetail open={open} setOpen={setOpen} data={showData} onSuccess={getAllBusiness} />
        </>
    )
}
