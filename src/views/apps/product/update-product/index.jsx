...
const UpdateProductTable = ({ reviewsData }) => {
    ...
    //             setAllData([])
    //             setData([])
    //             toast.info(res?.data?.errors || "Something went wrong")
    //         }
    //     } catch (error) {
    ...
    //             setAllData([])
    //             setData([])
    //             toast.info(res?.data?.errors || "Business Not Found ")
    //         }
    //     } catch (error) {
    //         const errorMessage = error.response?.data?.message || error.message || "Something went wrong"
    //         toast.error(errorMessage)
    ...
    const handleEditListing = id => {
        router.push(`/en/apps/product/add-product/${id}`)
    }
            ...
            columnHelper.accessor('actions', {
                ...
                cell: ({ row }) => (
                    <div className='flex items-center'>
                        <Button variant='contained' color='primary' onClick={() => handleEditListing(row.original._id)}>
                            Manage Products
                        </Button>
                    </div>
                ),
