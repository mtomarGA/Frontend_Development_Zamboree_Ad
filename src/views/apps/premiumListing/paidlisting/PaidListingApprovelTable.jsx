...
import PaidListingApprovel from '@/components/dialogs/premium-listing/Approvel/PaidListingApprovel'
...
const PaidListingApprovelTable = () => {
        ...
        <Card className='shadow-none '>
            ...
            <div className='flex flex-wrap justify-between gap-4 p-6'>
                <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
                    <CardHeader title='Paid Listing Approvel' />
            ...
            <Dialog fullWidth open={modalDetail} maxWidth='lg' scroll='body' sx={{ '& .MuiDialog-paper': { overflow: 'visible' } }}>
                ...
                <DialogTitle variant='h4' className='flex gap-2 flex-col text-center '>
                    <PaidListingDetail paidId={paidId} />
                </DialogTitle>
            </Dialog>
            ...
            <Dialog fullWidth open={EditModalOpen} maxWidth='sm' scroll='body' sx={{ '& .MuiDialog-paper': { overflow: 'visible' } }}>
                ...
                <DialogTitle variant='h4' className='flex gap-2 flex-col text-center   '>
                    <PaidListingApprovel getPaid={getPaid} PaidListing={EditSelectedPackage} setModalOpen={setEditModalOpen} paidId={paidId} />
                </DialogTitle>
            </Dialog>
        </Card>
    )
...
export default PaidListingApprovelTable
