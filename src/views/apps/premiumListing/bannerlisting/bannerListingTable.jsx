...
const BannerListingTable = () => {
    ...
    const getBanner = async () => {
        const res = await AllBanner.getAllBanner()
        setData(res.data)
    }
    ...
    const filteredData = useMemo(() => {
        ...
        if (statusFilter === 'PAID') return data.filter(item => item.status === 'PAID')
            ...
            columnHelper.accessor('actions', {
                ...
                cell: ({ row }) => (
                    <div className='flex items-center gap-2' >
                        {hasPermission("premium_banner_listing:view") && <IconButton onClick={() => handleDetail(row.original._id)}>
                            <Tooltip title="View" placement="top-end">
                                <i className='tabler-eye text-green-500 text-2xl cursor-pointer' />
                            </Tooltip>
                        </IconButton>}
                        {hasPermission("premium_banner_listing:edit") && <IconButton
                            onClick={() => {
                        ...
                        {hasPermission("premium_banner_listing:delete") && <IconButton onClick={() => handleDelete(row.original._id)}>
        ...
        <Card className='shadow-none '>
            ...
            <div className='flex flex-wrap justify-between gap-4 p-6'>
                <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
                    <CardHeader title='Banner Listing' />
                ...
                <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
                    ...
                    <Grid container xs={8} className='flex items-center justify-between px-5'>
                        ...
                        {hasPermission("premium_banner_listing:add") && <Button
                            variant='contained'
            ...
            <Dialog fullWidth open={modalOpen} maxWidth='md' scroll='body' sx={{ '& .MuiDialog-paper': { overflow: 'visible' } }}>
                ...
                <DialogTitle variant='h4' className='flex gap-2 flex-col text-center '>
                    <AddBannerListing setModalOpen={setModalOpen} getBanner={getBanner} />
                </DialogTitle>
            </Dialog>
...
export default BannerListingTable
