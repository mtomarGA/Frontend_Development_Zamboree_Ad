...
import FixedListingApprovel from '@/components/dialogs/premium-listing/Approvel/FixedListingApprovel'
...
const FixedListingApprovelTable = () => {
    ...
    const getSingleBanner = async (fixedListingId) => {
        const result = await FixedListing.getSingleFixedListing(fixedListingId)
        setBannerData(result.data || [])
    }
    useEffect(() => {
        if (EditSelectedPackage?._id) {
            const PaidListingId = EditSelectedPackage?._id
            ...
            columnHelper.accessor('actions', {
                ...
                cell: ({ row }) => (
                    <div className='flex items-center gap-2' >
                        <IconButton onClick={() => handleDetail(row.original._id)}>
        ...
        <Card className='shadow-none '>
            ...
            <div className='flex flex-wrap justify-between gap-4 p-6'>
                <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
                    <CardHeader title='Fixed Listing Approvel' />
            ...
            <Dialog fullWidth open={modalDetail} maxWidth='lg' scroll='body' sx={{ '& .MuiDialog-paper': { overflow: 'visible' } }}>
                ...
                <DialogTitle variant='h4' className='flex gap-2 flex-col text-center '>
                    <FixedListingDetail FixedListing={fixedId} />
                </DialogTitle>
            </Dialog>
            ...
            <Dialog fullWidth open={EditModalOpen} maxWidth='sm' scroll='body' sx={{ '& .MuiDialog-paper': { overflow: 'visible' } }}>
                ...
                <DialogTitle variant='h4' className='flex gap-2 flex-col text-center   '>
                    <FixedListingApprovel FixedListing={EditSelectedPackage} onSuccess={setEditModalOpen} get={getFixed} />
                </DialogTitle>
            </Dialog>
        </Card>
    )
...
export default FixedListingApprovelTable
