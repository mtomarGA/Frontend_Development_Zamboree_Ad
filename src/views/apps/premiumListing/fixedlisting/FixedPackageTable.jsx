...
import AddFixedPackage from '@/components/dialogs/premium-listing/fixed-listing/master/addFixedPackage'
import FixedPackage from "@/services/premium-listing/fixedPackage.service"
...
const FixedPackageTable = () => {
    ...
    const getPackage = async () => {
        const res = await FixedPackage.getAllFixedPackage()
        setData(res.data)
    }

    const handleDelete = async (packageId) => {
        const result = await FixedPackage.deleteFixedListing(packageId)
            ...
            columnHelper.accessor('actions', {
                ...
                cell: ({ row }) => (
                    <div className='flex items-center gap-2' >
                        {hasPermission("premium_fixed_master:edit")&&<IconButton
                            onClick={() => {
                        ...
                        {hasPermission("premium_fixed_master:delete")&&<IconButton onClick={() => handleDelete(row.original._id)}>
        ...
        <Card className='shadow-none '>
            <div className='flex flex-wrap justify-between gap-4 p-6'>
                <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
                    <CardHeader title='Fixed Package' />
                ...
                <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
                    ...
                    <Grid container xs={8} className='flex items-center justify-between px-5'>
                        ...
                        {hasPermission("premium_fixed_master:add")&&<Button
                            variant='outlined'
            ...
            <Dialog fullWidth open={modalOpen} maxWidth='md' scroll='body' sx={{ '& .MuiDialog-paper': { overflow: 'visible' } }}>
                ...
                <DialogTitle variant='h4' className='flex gap-2 flex-col text-center '>
                    <AddFixedPackage onsuccess={setModalOpen} getPackage={getPackage} />
                </DialogTitle>
            </Dialog>
...
export default FixedPackageTable
