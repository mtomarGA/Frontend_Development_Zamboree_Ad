          ...
          <Grid size={{ xs: 12 }}>
            <div className='p-6 bg-actionHover rounded'>
              <div className='flex justify-between gap-4 flex-col sm:flex-row '>
                ...
                <div className='flex flex-col gap-6'>
                  <Typography variant='h5'>{`Invoice  Id # ${invoiceData?.InvoiceId || invoiceData?.INVOICEDID}`}</Typography>
            ...
            <Grid container spacing={6}>
              ...
              <Grid size={{ xs: 12, sm: 6 }}>
                <div className='flex flex-col gap-4'>
                  ...
                  <div>
                    <Typography>
                      {invoiceData?.invoiceBy
                        ? `${invoiceData.invoiceBy.employee_id || 'Admin'} `
                        : invoiceData?.invoicedBy
                          ? `${invoiceData.invoicedBy.employee_id || 'Admin'}`
                          : ''}
                    </Typography>
              ...
              <table className={tableStyles.table}>
                <thead className='border-bs-0'>
                  <tr>
                    ...
                    {/* <th className='!bg-transparent'>Phone No</th> */}
