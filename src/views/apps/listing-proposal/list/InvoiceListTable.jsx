...
import AllProposal from '@/services/premium-listing/banner.service'
// Third-party Imports
    ...
    () => [
      {
        ...
        header: 'Proposal ID',
        cell: ({ row }) => (
          <Typography color='primary.main'>#{row.original.PROPOSALId}</Typography>
        )
      },
      {
        accessorKey: 'invoiceid',
      ...
      },
      {
        ...
        (
          <Chip
            ...
            color={row.original.status === 'PROPOSAL' ? 'success' : 'warning'}
            size='small'
          />
        )
      },
...

      {
        ...
        cell: ({ row }) => (
          <>
            <Link href={`/en/apps/listingInvoice/preview/${row.original._id}`}>
