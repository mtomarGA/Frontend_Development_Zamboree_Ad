...
const HinduContentNew = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await hinduContentService.create(data);
        router.push('/en//apps/spritual/hinduism/content')
                            ...
                            <FileUploader
                                ...
                                onFileSelect={async (file) => {
                                    if (file) {
                                        ...
                                        const uploaded = await ImageService.uploadImage(formData, {folder:"Spiritual/Hinduism/Content"});
                                        handleChange({
                                            target: {
                                                name: 'web_image',
...
export default HinduContentNew;
