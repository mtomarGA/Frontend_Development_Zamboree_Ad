...
const ManageContent = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true)
      const response = await hinduContentService.getAll()
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex gap-2'>
            ...
            {hasPermission('spiritual_hinduism_manage_content:edit') && <button onClick={() => router.push(`/en/apps/spritual/hinduism/content/${row.original._id}`)}
              className='text-blue-600  tabler-edit text-xl cursor-pointer'
            ></button>}
            {hasPermission('spiritual_hinduism_manage_content:view') && <button onClick={() => {
          ...
          <Card>
            <CardContent className='flex flex-col gap-4 sm:flex-row items-start sm:items-center justify-between flex-wrap'>
              ...
              <div className='flex flex-wrap gap-4'>
                ...
                />
                {hasPermission('spiritual_hinduism_manage_content:add') && <Button variant='contained' onClick={() => router.push('/en/apps/spritual/hinduism/content/new')}>
                  Add Content
                </Button>}
              </div>
            </CardContent>
