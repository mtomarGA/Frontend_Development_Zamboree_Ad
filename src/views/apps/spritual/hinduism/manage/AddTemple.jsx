...
const AddTemple = ({ handleAddView }) => {
    ...
    const {templeTabManager, setTempleTabManager} = useTempleContext()
    ...
    return (
        <TabContext value={value}>
            ...
            <TabPanel value='1' sx={{ width: '100%' }}>
                <Overview handleCancel={handleAddView} nextHandle={() => setValue('2')} />
            </TabPanel>
            <TabPanel value='2' sx={{ width: '100%' }}>
                <Timing handleCancel={handleAddView} nextHandle={() => setValue('3')} />
            </TabPanel>
            <TabPanel value='3' sx={{ width: '100%' }}>
                <SocialMedia handleCancel={handleAddView} nextHandle={() => setValue('4')} />
            </TabPanel>
            <TabPanel value='4' sx={{ width: '100%' }}>
                <Gallery handleCancel={handleAddView} nextHandle={() => setValue('5')} />
            </TabPanel>
            <TabPanel value='5' sx={{ width: '100%' }}>
                <DonationList handleCancel={handleAddView} nextHandle={() => setValue('6')} />
            </TabPanel>
            <TabPanel value='6' sx={{ width: '100%' }}>
                <Security handleCancel={handleAddView} nextHandle={() => setValue('7')} />
            </TabPanel>
        </TabContext>
