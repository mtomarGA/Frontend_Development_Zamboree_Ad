...
const JainContentNew = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await JainContentService.create(data);
        router.push('/en/apps/spritual/jain/content')
    ...
    const categoryList = [
        ...
        // "pooja" , "chalisa" , "chalisa", "aarti", "paath" , "bhajan", "parv_katha" , "jain_kahaniya", "stotra"
        {value:"pooja" , label:"Pooja"},
        {value:"chalisa" , label:"Chalisa"},
        {value:"aarti" , label:"Aarti"},
        {value:"paath" , label:"Paath"},
        {value:"bhajan" , label:"Bhajan"},
        {value:"parv_katha" , label:"Parv Katha"},
        {value:"jain_kahaniya" , label:"Jain Kahaniya"},
        {value:"stotra" , label:"Stotra"},
                            ...
                            <FileUploader
                                ...
                                onFileSelect={async (file) => {
                                    if (file) {
                                        ...
                                        const uploaded = await ImageService.uploadImage(formData, {folder:"Spiritual/Jainism/Content"});
                                        handleChange({
                                            target: {
                                                name: 'web_image',
