...
const ImageUploadSection = ({ title, images, setImages, type, error_message }) => {
  const { tempImageIds, setTempImageIds, setGalleryErrors, resetForm } = useJainism()
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      const uploaded = await ImageService.uploadMultipleImage(files,{isWatermarked: type === 'galleryImages', folder: "Spiritual/Jainism/Temple"})
...
const Gallery = ({ nextHandle, handleCancel }) => {
  const {
    ...
    galleryImages, setGalleryImages, validateGalleryImages, galleryErrors, setGalleryErrors, setTempleTabManager } = useJainism()
