...
const SikhContentNew = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await sikhContentService.create(data);
        router.push('/en/apps/spritual/sikh/content')
                ...
                {loading ? (
                    ...
                    <Card>
                        <CardContent className='flex flex-col gap-4 sm:flex-row items-start sm:items-center justify-between flex-wrap'>
                            ...
                            <Button disabled={imageLoading.mobile_image || imageLoading.web_image} variant='contained' color='primary' onClick={handleSubmit} className='mt-4 sm:mt-0'>Submit</Button>
