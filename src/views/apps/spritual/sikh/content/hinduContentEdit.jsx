...
const SikhContentEdit = () => {
    ...
    const fetchData = async () => {
        setLoading(true)
        try {
            const response = await sikhContentService.getById(id);
    ...
    const handleSubmit = async (e) => {
        ...
        await sikhContentService.update(id, data);
    ...
    const categoryList = [
        ...
        { value: "sikh_guru", label: "Sikh Guru" },
        { value: "guru_grant_sahib", label: "Guru Grant Sahib" },
        { value: "guru_sakhi", label: "Guru Sakhi" },

        // "nitnem" , "sikh_guru" , "guru_grant_sahib", "guru_sakhi"
    ]
                    ...
                    <Card>
                        <CardContent className='flex flex-col gap-4 sm:flex-row items-start sm:items-center justify-between flex-wrap'>
                            ...
                            <FileUploader
                                ...
                                onFileSelect={async (file) => {
                                    if (file) {
                                        ...
                                        const uploaded = await ImageService.uploadImage(formData, {folder:"Spiritual/Sikhism/Content"});
                                        handleChange({
                                            target: {
                                                name: 'web_image',
                            ...
                            <Grid className='flex justify-end w-full '>
                                <Button className=' mt-4 sm:mt-0' disabled={imageLoading.mobile_image || imageLoading.web_image} variant='contained' color='primary' onClick={handleSubmit}>Update</Button>
...
export default SikhContentEdit;
