...
const Timing = ({ nextHandle, handleCancel }) => {
  const { timingFormData, setTimingFormData,timingErrors , validateTiming, setTimingErrors, setGurudwaraTabManager } = useGurudwara()
  ...
  const handleSubmit = (e) => {
    ...
    if (isValid) {
      setGurudwaraTabManager(prev => ({ ...prev, socialmedia: true }))
      nextHandle()
    }
  }
