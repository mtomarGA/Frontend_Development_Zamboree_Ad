...
const ImageUploadSection = ({ title, images, setImages, type, error_message }) => {
  const { tempImageIds, setTempImageIds, setGalleryErrors ,resetForm  } = useGurudwara()
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      setLoading(true)
      const uploaded = await ImageService.uploadMultipleImage(files,{isWatermarked: type === 'galleryImages', folder: "Spiritual/Sikhism/Temple"})
...
const Gallery = ({ nextHandle, handleCancel }) => {
  const {
    ...
    galleryImages, setGalleryImages, validateGalleryImages, galleryErrors, setGalleryErrors , setGurudwaraTabManager } = useGurudwara()
  ...
  const handleSubmit = (e) => {
    ...
    setGurudwaraTabManager(prev => ({ ...prev, donation: true }))
    nextHandle()
  }
