...
const Festival = ({ handleAddEmployee }) => {
  // States
  ...
  const fetchData = async () => {
    try {
      setLoading(true)
      const response = await ChristFestivalService.getAll()
            ...
            columnHelper.accessor('date', {
              ...
              cell: ({ row }) => (
                <Typography color='text.primary'>
                  {row.original.createdAt ? new Date(row.original.date).toLocaleDateString('en-GB', {
                    day: '2-digit',
                    month: '2-digit',   
                    year: 'numeric',
                  }) : 'N/A'}
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex gap-2'>
            {hasPermission('spiritual_christ_festival:edit') && <button onClick={() => {
            ...
            ></button>}
            {hasPermission('spiritual_christ_festival:delete') && <button
    ...
    <Grid className='' container>
      ...
      <Grid className='w-full' item xs={12}>
          ...
          <Card>
            <CardContent className='flex flex-col gap-4 sm:flex-row items-start sm:items-center justify-between flex-wrap'>
              ...
              <div className='flex flex-wrap gap-4'>
                ...
                />
                {hasPermission('spiritual_christ_festival:add') && <Button variant='contained' onClick={() => { setOpen(true); setEditValue(null) }}>
                  Add Festival
                </Button>}
              </div>
            </CardContent>
        ...
        <HinduFestivalModal
          ...
          folderName='Spiritual/Christianity/Festival'
          title='Festival Name'
        />
      </Grid>
    </Grid>
