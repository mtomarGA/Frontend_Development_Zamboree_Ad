...
const NewContent = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await ChristContentService.create(data);
        router.push('/en/apps/spritual/christ/content')
                ...
                {loading ? (
                    ...
                    <Card>
                        <CardContent className='flex flex-col gap-4 sm:flex-row items-start sm:items-center justify-between flex-wrap'>
                            ...
                            <FileUploader
                                ...
                                onFileSelect={async (file) => {
                                    if (file) {
                                        ...
                                        const uploaded = await ImageService.uploadImage(formData, { folder: "Spiritual/Christianity/Content" });
                                        handleChange({
                                            target: {
                                                name: 'web_image',
                            ...
                            <Button disabled={imageLoading.mobile_image || imageLoading.web_image || loading} variant='contained' color='primary' onClick={handleSubmit} className='mt-4 sm:mt-0'>Submit</Button>
