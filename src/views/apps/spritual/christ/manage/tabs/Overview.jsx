        ...
        <Card sx={{ p: 5 }} component="form" onSubmit={handleNextButtonClick}>
            ...
            <Grid container spacing={4}>
                ...
                <Grid item xs={12} sm={6}>
                    <CustomTextField fullWidth required label="Chruch Name" name="templeName" value={formData.temple_name} onChange={handleChange("temple_name")} error={!!errors.temple_name}
                        ...
                        <FileUploader
                            onFileSelect={async (file) => {
                                ...
                                if (file) {
                                    ...
                                    const uploadedFile = await ImageService.uploadImage(formData, { folder: "Spiritual/Christianity/Temple" })
