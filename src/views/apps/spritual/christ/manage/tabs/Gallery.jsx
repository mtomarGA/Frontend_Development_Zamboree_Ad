...
const ImageUploadSection = ({ title, images, setImages, type, error_message }) => {
  const { tempImageIds, setTempImageIds, setGalleryErrors ,resetForm  } = useChrist()
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      const uploaded = await ImageService.uploadMultipleImage(files,{isWatermarked: type === 'galleryImages',folder: "Spiritual/Christianity/Temple"})
...
const Gallery = ({ nextHandle, handleCancel }) => {
  const {
    ...
    galleryImages, setGalleryImages, validateGalleryImages, galleryErrors, setGalleryErrors , setTempleTabManager } = useChrist()
