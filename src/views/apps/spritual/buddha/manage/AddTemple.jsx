...
const AddBuddhaTemple = ({ handleAddView }) => {
    // States
    ...
    const { templeTabManager, setTempleTabManager } = useBuddhism()
    ...
    const handleCancel = () => router.push(`/en/apps/spritual/buddha/manage`)
...
export default AddBuddhaTemple
