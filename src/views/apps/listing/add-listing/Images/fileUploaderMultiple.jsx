...
const FileUploader = ({ onFileSelect, initialFile, error_text, imageUploading, imageId, setImageUploading , folderPath }) => {
        ...
        <>
            <div {...getRootProps({ className: 'dropzone' })}>
                ...
                {!file && <div className='flex items-center flex-col'>
                    ...
                    <Typography variant='h4' className='mbe-2.5'>Upload Business image</Typography>
