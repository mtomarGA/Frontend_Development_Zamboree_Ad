...
// Component Imports
import AddCities from '@components/dialogs/add-cities'
...
import AddCityInfo from '@components/dialogs/add-cities'
...
const CitiesListTable = () => {
  ...
  const handleDelete = async id => {
    console.log(id, 'row')
    const data = await CityService.deleteCity(id)
  ...
  const handleEditCity = async (id) => {
    const stateData = await CityService.getSingleCity(id)
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            {hasPermission("partner_master:edit") &&
              <IconButton onClick={() => handleEditCity(row.original._id)}>
  ...
  return (
    <>
      <Card>
        ...
        {/* <TableFilters setData={setFilteredData} cityData={data} /> */}
        <Divider />
      ...
      <AddCityInfo open={open} setOpen={setOpen} data={editData} onSuccess={handleGet} />
    </>
  )
}
