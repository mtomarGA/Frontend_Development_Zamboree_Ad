...
import AddBankerName from '@components/dialogs/add-bankerName'
...
const BankerNameTable = () => {
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            {hasPermission("partner_master:edit") &&
              <IconButton onClick={() => handleEditBank(row.original)}>
                <i className='tabler-edit text-blue-500' />
              </IconButton>}
            {hasPermission("partner_master:delete") &&
              <DeleteConfirmationDialog
                itemName="banker name"
                onConfirm={() => handleDeleteBank(row.original._id)}
  ...
  return (
    <>
      ...
      <AddBankerName open={open} setOpen={setOpen} data={editData} onSuccess={handleGetBank} />
    </>
  )
}

export default BankerNameTable
