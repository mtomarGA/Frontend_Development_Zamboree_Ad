...
function EventApproval() {
    ...
    return (
        <>
            ...
            <h3 className='m-2'>Event Approval</h3>
            ...
            <TabContext value={value}>
                ...
                <TabPanel value='2'>
                    ...
                    <AllActive statusStyles={statusStyles} getcoupon={getcoupon} coupondata={ActiveCoupon} />

                </TabPanel>
                <TabPanel value='3'>

                    <PendingTable statusStyles={statusStyles} getcoupon={getcoupon} coupondata={PendingCoupon} />

                </TabPanel>
                <TabPanel value='4'>
                    <ExpiredTable statusStyles={statusStyles} getcoupon={getcoupon} coupondata={ExpiredCoupon} />

                </TabPanel>
                <TabPanel value='5'>

                    <RejectedTable statusStyles={statusStyles} getcoupon={getcoupon} coupondata={RejectedCoupon} />
