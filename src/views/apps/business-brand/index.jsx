...
import BusinessBrand from '@/components/dialogs/business-brand'
...
const BusinessBrandTable = () => {
    useEffect(() => {
        getBusinessBrand()
    }, [])
    const { hasPermission } = useAuth();

    const getBusinessBrand = async () => {
        const res = await BusinessBrandService.getBussinessBrand()
    ...
    const handleDelete = async (id) => {
        const result = await BusinessBrandService.deleteBussinessBrand(id)
    ...
    return (
        <Card>
            <Typography variant='h3' className='px-7 py-2'>All Business Brand</Typography>
            ...
            <Dialog fullWidth open={EditModalOpen} maxWidth='sm' scroll='body' sx={{ '& .MuiDialog-paper': { overflow: 'visible' } }}>
                ...
                <DialogTitle variant='h4' className='flex gap-2 flex-col text-center sm:pbs-16 '>
                    <BusinessBrand setEditModalOpen={setEditModalOpen} getBusinessBrand={getBusinessBrand} EditSelectedUser={EditSelectedUser} />
                </DialogTitle>
            </Dialog>
        </Card>
    )
...
export default BusinessBrandTable
