...
function SubCategoryTable({ handleClickOpen, quizType, GetCategoryFun }) {
    ...
    const Editid = async (row) => {
        // console.log(id);
        handleEditOpen();
        // const res = await TrueAndFalseSubCategoryRoute.getdatabyid(id);
        setEditData(row);
    ...
    const handleSubmit = async () => {
        ...
        const response = await TrueAndFalseSubCategoryRoute.putData(EditData._id, EditData);
    ...
    const deleteid = async (id) => {
        const res = await TrueAndFalseSubCategoryRoute.deleteData(id);
    ...
    const handleDragEnd = async (result) => {
        ...
        try {
            ...
            await TrueAndFalseSubCategoryRoute.updateOrder(updatedOrder)
        ...
        <div>
            ...
            <TableContainer className='shadow p-6'>
                <div className='flex justify-between items-center mb-4'>
                    <h3 className='mb-4'>True And False SubCategory</h3>
