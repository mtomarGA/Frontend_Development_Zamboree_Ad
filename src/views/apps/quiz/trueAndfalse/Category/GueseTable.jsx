...
function GuesTheWordTable({ handleClickOpen, quizType, GetCategoryFun }) {
    ...
    const Editid = async (id) => {
        handleEditOpen();
        const res = await TrueAndFalseCategoryRoute.getdatabyid(id);
        const data = res.data || {};
        setEditData({
    ...
    const handleSubmit = async () => {
        ...
        const response = await TrueAndFalseCategoryRoute.putData(EditData._id, EditData)
    ...
    const deleteid = async (id) => {
        const res = await TrueAndFalseCategoryRoute.deleteData(id);
    ...
    const handleDragEnd = async (result) => {
        ...
        try {
            ...
            await TrueAndFalseCategoryRoute.updateOrder(updatedOrder)
        ...
        <div>
            ...
            <TableContainer className='shadow p-6'>
                <div className='flex justify-between items-center mb-4'>
                    <h3 className='mb-4'>True And False</h3>
