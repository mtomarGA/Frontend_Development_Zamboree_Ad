...
const AddModal = ({ open, handleClose, handleClickOpen, GetLevelFun }) => {
    ...
    const fetchsubcategory = async () => {
        const res = await TrueAndFalseSubCategoryRoute.subcategory(Adddata?.category || []);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await TrueAndFalseLevelRoute.Post(Adddata)
