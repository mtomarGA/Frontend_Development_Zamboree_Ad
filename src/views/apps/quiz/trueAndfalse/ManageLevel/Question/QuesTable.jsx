...
function QuesTable({ handleClickOpen }) {
    ...
    const fetchData = async () => {
        try {
            const res = await TrueFalseQuesService.getdatabyid(id)
            // const res = await TrueFalseQuesService.Get();
            setGetQues(res.data)
        } catch (error) {
    ...
    const handleSubmit = async () => {
        ...
        const response = await TrueFalseQuesService.putData(editData.id, formData)
        ...
        <div>
            ...
            <TableContainer className="shadow p-6">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="mb-4">True & False Questions</h3>
