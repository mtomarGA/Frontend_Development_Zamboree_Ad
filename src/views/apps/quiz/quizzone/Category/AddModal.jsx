...
const AddModal = ({ open, handleClose, handleClickOpen, GetCategoryFun }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await QuizCategoryRoute.Post(Adddata)
            ...
            const activityData = {
                details: "Quiz Zone Category Added",
                coins: Adddata.coins,
            }
            const postActivity = await ActivityService.Post(activityData);
            console.log(postActivity, "sjkdjjmd");
