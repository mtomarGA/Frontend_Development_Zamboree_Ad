...
function FunAndLearnTable({ handleClickOpen, quizType, GetCategoryFun }) {
    ...
    const Editid = async (id) => {
        ...
        handleEditOpen();
        const res = await FunCategoryRoute.getdatabyid(id);
    ...
    const handleSubmit = async () => {
        ...
        const response = await QuizCategoryRoute.putData(EditData._id, EditData)
    ...
    const deleteid = async (id) => {
        const res = await FunCategoryRoute.deleteData(id);
    ...
    const handleDragEnd = async (result) => {
        ...
        try {
            ...
            await FunCategoryRoute.updateOrder(updatedOrder)
        ...
        <div>
            ...
            <TableContainer className='shadow p-6'>
                <div className='flex justify-between items-center mb-4'>
                    <h3 className='mb-4'>Fun And Learn</h3>
...
export default FunAndLearnTable
