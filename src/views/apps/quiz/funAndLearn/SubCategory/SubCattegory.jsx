...
function SubCategoryTable1({ handleClickOpen, quizType, GetCategoryFun }) {
    // const quizType = [{
    //     categoryName: "hiii"
    // }]
    ...
    const Editid = async (id) => {
        // console.log(id);
        handleEditOpen();
        const res = await FunAndLearnSubCategoryRoute.getdatabyid(id);
    ...
    const handleSubmit = async () => {
        ...
        const response = await FunAndLearnSubCategoryRoute.putData(EditData._id, EditData);
    ...
    const deleteid = async (id) => {
        const res = await FunAndLearnSubCategoryRoute.deleteData(id);
    ...
    const handleDragEnd = async (result) => {
        ...
        try {
            ...
            await FunAndLearnSubCategoryRoute.updateOrder(updatedOrder)
    ...
    const FetchCategory = async () => {
        setLoading(true);
        try {
            const res = await FunAndLearnSubCategoryRoute.searchcategory({ category: search });
        ...
        <div>
            ...
            <TableContainer className='shadow p-6'>
                <div className='flex justify-between items-center mb-4'>
                    <h3 className='mb-4'>Fun And Learn SubCategory</h3>
...
export default SubCategoryTable1
