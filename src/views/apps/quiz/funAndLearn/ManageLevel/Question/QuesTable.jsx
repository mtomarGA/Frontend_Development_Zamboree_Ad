...
function QuesTable({ handleClickOpen }) {
    ...
    const fetchData = async () => {
        try {
            const res = await FunQuesService.getdatabyid(id)
            setGetQues(res.data)
        } catch (error) {
        ...
        if (question) {
            ...
            setQuestionType(
                question.questionType
                    ? question.questionType
                    : (question.optionC || question.optionD ? 'options' : 'truefalse')
            );
        } else {
    ...
    const handleSubmit = async () => {
        ...
        const response = await FunQuesService.putData(editData.id, formData)
    ...
    const deleteid = async (id) => {
        ...
        try {
            const response = await FunQuesService.deleteData(id)
            if (response?.data === null) {
            ...
            >
                ...
                <DialogActions>
                    ...
                    {hasPermission("quiz_funAndLearn:edit") &&
                        <Button onClick={handleSubmit} variant="contained" disabled={editData.icon}>
                            Edit Question
                        </Button>
                    }
