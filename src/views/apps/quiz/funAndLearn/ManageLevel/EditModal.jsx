...
const EditModal = ({ levelEditOpen, handlelevelEditClose, GetLevelFun, selectedLevel }) => {
    ...
    const fetchsubcategory = async () => {
        const res = await FunAndLearnSubCategoryRoute.subcategory(EditData?.category || []);
    ...
    const handleSubmit = async () => {
        ...
        const response = await FunAndLearnLevelRoute.putData(selectedLevel?._id, EditData)
