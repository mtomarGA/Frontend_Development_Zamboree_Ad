...
const AddModal = ({ open, handleClose, handleClickOpen, GetLevelFun }) => {
    ...
    const fetchsubcategory = async () => {
        const res = await GuesTheWordSubCategoryRoute.subcategory(Adddata?.category || []);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await GuesTheWordLevelRoute.Post(Adddata)
                ...
                <DialogContent>
                    ...
                    <div className='m-2'>
                        <CustomTextField
                            ...
                            onChange={handleChange}
                            value={Adddata.hint_deduct_Coins || ''}
                            multiline
                            rows={1}
                            variant='outlined'
