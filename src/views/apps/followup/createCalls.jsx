...
const FollowUpCallsCreate = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            await FollowUpCallService.create(bodyData)
        } catch (error) {
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        <Autocomplete
                            ...
                            onInputChange={(e, newInputValue, reason) => {
                                ...
                                if (reason === 'input') {
                                    setFormErrors(prev => ({ ...prev, business_id: '' })) // Clear error when typing
                                    debouncedSearch(newInputValue)
                                }
                            }}
                            renderInput={(params) => <CustomTextField {...params} label="Search Business" placeholder="Type at least 3 characters" error={Boolean(formErrors.business_id)} helperText={formErrors.business_id} />}
...
export default FollowUpCallsCreate
