...
import CallStatusService from '@/services/follow-up/callStatusService'
...
const CallStatusTable = () => {
  ...
  const handleUpdate = async data => {
    ...
    setEditValue('')
    setOpen(false)
    await CallStatusService.update(data._id, data)
    fetchData()
    setLoading(false)
  }
  ...
  const handleAdd = async data => {
    ...
    await CallStatusService.create(data)
  ...
  const handleDelete = async id => {
    setLoading(true)
    await CallStatusService.delete(id)
    fetchData()
    setLoading(false)
  }
  const handleClose = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true)
      const response = await CallStatusService.get()
