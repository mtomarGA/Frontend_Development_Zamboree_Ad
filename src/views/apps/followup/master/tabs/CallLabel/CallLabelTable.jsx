...
import CallLabelService from '@/services/follow-up/callLabelService'
...
const CallLabelTable = () => {
  ...
  const handleUpdate = async data => {
    ...
    setEditValue('')
    setOpen(false)
    await CallLabelService.update(data._id, data)
    fetchData()
    setLoading(false)
  }
  ...
  const handleAdd = async data => {
    ...
    await CallLabelService.create(data)
  ...
  const handleDelete = async id => {
    setLoading(true)
    await CallLabelService.delete(id)
    fetchData()
    setLoading(false)
  }
  const handleClose = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true)
      const response = await CallLabelService.get()
