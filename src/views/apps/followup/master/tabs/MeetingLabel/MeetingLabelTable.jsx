...
const MeetingLabelTable = () => {
  ...
  const handleUpdate = async data => {
    ...
    setEditValue('')
    setOpen(false)
    await MeetingLabelService.update(data._id, data)
    fetchData()
    setLoading(false)
  }
  ...
  const handleAdd = async data => {
    ...
    await MeetingLabelService.create(data)
  ...
  const handleDelete = async id => {
    setLoading(true)
    await MeetingLabelService.delete(id)
    fetchData()
    setLoading(false)
  }
  const handleClose = () => {
...
export default MeetingLabelTable
