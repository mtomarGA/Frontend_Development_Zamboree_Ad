...
import ServiceNameService from '@/services/follow-up/serviceNameService'
...
const ServiceTable = () => {
  ...
  const handleUpdate = async data => {
    ...
    setEditValue('')
    setOpen(false)
    await ServiceNameService.update(data._id, data)
    fetchData()
    setLoading(false)
  }
  ...
  const handleAdd = async data => {
    ...
    await ServiceNameService.create(data)
  ...
  const fetchData = async () => {
    try {
      setLoading(true)
      const response = await ServiceNameService.get()
