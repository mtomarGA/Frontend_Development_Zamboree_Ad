...
const AwardTypeTable = () => {
  ...
  const handleAdd = async data => {
    setLoading(true)
    setEditValue('')
    await awardTypeServices.createAwardType(data)
    setOpen(false)
    setEditValue('')
    fetchData()
    setLoading(false)
  ...
  const fetchData = async () => {
    try {
      setLoading(true)
      const response = await awardTypeServices.getAllAwardType()
  ...
  const handleUpdate = async data => {
    ...
    setEditValue('')
    setOpen(false)
    await awardTypeServices.updateAwardType(data._id, data)
    fetchData()
    setLoading(false)
  }
  ...
  const handleDelete = async id => {
    setLoading(true)
    await awardTypeServices.deleteAwardType(id)
    fetchData()
    setLoading(false)
  }
  const handleClose = () => {
