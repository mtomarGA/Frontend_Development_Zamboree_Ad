...
const AwardTypeTable = () => {
  ...
  const handleAdd = async data => {
    setLoading(true)
    setEditValue('')
    await complainTypeServices.createComplainType(data)
    setOpen(false)
    setEditValue('')
    fetchData()
    setLoading(false)
  ...
  const fetchData = async () => {
    try {
      setLoading(true)
      const response = await complainTypeServices.getAllComplainType()
  ...
  const handleUpdate = async data => {
    ...
    setEditValue('')
    setOpen(false)
    await complainTypeServices.updateComplainType(data._id, data)
    fetchData()
    setLoading(false)
  }
  ...
  const handleDelete = async id => {
    setLoading(true)
    await complainTypeServices.deleteComplainType(id)
    fetchData()
    setLoading(false)
  }
  const handleClose = () => {
