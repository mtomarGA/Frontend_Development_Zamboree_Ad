...
import AdminEmailUpdate from '@/components/dialogs/admin-detail-update'
...
const UserDropdown = () => {
  ...
  return (
    <>
            ...
            <Paper className={settings.skin === 'bordered' ? 'border shadow-none' : 'shadow-lg'}>
              <ClickAwayListener onClickAway={e => handleDropdownClose(e)}>
                <MenuList>
                  <div className='flex items-center plb-2 pli-6 gap-2' tabIndex={-1}>
                    ...
                    <div className='flex items-start flex-col'>
                      <Typography className='font-medium' color='text.primary'>
                        {user?.firstName + ' ' + user?.lastName || session?.user?.firstName + ' ' + session?.user?.lastName || ''}
                      </Typography>
                  ...
                  {user.userType === "ADMIN" && <div className='flex items-center plb-2 pli-3'>
                    <Button
                      fullWidth
                      variant='contained'
                      color='primary'
                      ...
                      onClick={() => setAdminProfileModal(true)}
      ...
      <AdminEmailUpdate open={adminProfileModal} handleClose={() => setAdminProfileModal(false)} />
    </>
  )
}
