...
const LeaveNameForm = ({ setModalOpen, EditSelectedLeaveType, getLeave }) => {
    ...
    const onSubmit = async (data) => {
        ...
        if (EditSelectedLeaveType?._id) {
            ...
            const result = await leaveNameService.updateLeaveName(id, formData)
            toast.success(result.message)
        } else {
            const result = await leaveNameService.createleaveName(formData)
            toast.success(result.message)
        }
        getLeave()
        reset()
