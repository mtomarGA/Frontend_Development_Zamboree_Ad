...
const KeywordManager = ({ businessKeyword, handleKeyword, keywords, handleNextClick, data, handlePreviousClick }) => {
  ...
  useEffect(() => {
    if (keywords) {
      setLocalBusinessKeyword(keywords)
    }
  }, [keywords])
  ...
  useEffect(() => {
    const loadKeywords = async () => {
      try {
        setLoading(true);
        const transformedBusiness = transformKeywords(businessKeyword);
 ...
 const handleAddKeywords = () => {
  ...
  // Add the handleRemoveKeyword function here
            ...
            <CardContent className="h-full flex flex-col">
              ...
              <Box mt={2}>
                ...
                <Box display="flex" justifyContent="space-between" alignItems="center">
                  <Button variant="outlined" onClick={handlePrivious}>
                    Previous
                  </Button>
                  <Button
                    variant="contained"
