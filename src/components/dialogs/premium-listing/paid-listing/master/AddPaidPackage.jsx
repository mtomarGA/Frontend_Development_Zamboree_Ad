...
import PaidPackageService from '@/services/premium-listing/paidPackage.service';

const AddPaidPackageListing = ({ onsuccess, getPackage }) => {
    ...
    const handleSave = async () => {
        ...
        if (!hasError) {
            const result = await PaidPackageService.addPaidPackage(formData);
            onsuccess(false)
            getPackage()
    ...
    return (
        <Card className='shadow-none'>
            <CardHeader title='Create Package' />
            <CardContent>
...
export default AddPaidPackageListing;
