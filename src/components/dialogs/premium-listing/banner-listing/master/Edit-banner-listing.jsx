...
import PackageService from '@/services/premium-listing/package.service';

const EditPackageListing = ({ onsuccess, getPackage, EditSelectedPackage }) => {
    ...
    const handleSave = async () => {
        ...
        if (!hasError) {
            ...
            const result = await PackageService.updatePackage(packageId, formData)
            onsuccess(false)
            getPackage()
    ...
    return (
        <Card className='shadow-none'>
            <CardHeader title='Edit Banner Package' />
            <CardContent>
...
export default EditPackageListing;
