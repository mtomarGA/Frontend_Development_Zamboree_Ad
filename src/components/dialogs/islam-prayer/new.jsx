...
const IslamPrayerAddModal = ({ open, data, handleUpdate, handleAdd, handleClose, title }) => {
    ...
    return (
        ...
        >
            ...
            {data ? (
                <EditContent handleClose={handleClose} handleUpdate={handleAdd} data={data} title={title} />
            ) : (
...
export default IslamPrayerAddModal
