...
import StoryApprove from './StoryApprove'
...
const StoryApprovelTable = () => {
    ...
    const getusers = async () => {
        ...
        const res = await AllStory.getPenStory()
        setData(res.data)
    }
    useEffect(() => {
        getusers()
    ...
    console.log(EditSelectedPost,"EditSelectedPostEditSelectedPost");
        ...
        <Card className='shadow-none '>
            ...
            <Dialog fullWidth open={EditModalOpen} maxWidth='md' scroll='body' sx={{ '& .MuiDialog-paper': { overflow: 'visible' } }}>
                ...
                <DialogTitle variant='h4' className='flex gap-2 flex-col text-center  sm:pbe-6 sm:pli-16'>
                    <StoryApprove EditSelectedStory={EditSelectedPost} setEditModalOpen={setEditModalOpen} getData={getusers} />
                </DialogTitle>
            </Dialog>
        </Card>
    )
...
export default StoryApprovelTable
