...
// import EditUser from '@/components/dialogs/posts/EditPostDigog'
...
import Approve from './PostApprove'
...
const PostApprovel = () => {
    ...
    const getusers = async () => {
        const res = await getAllPosts.getPending()
        ...
        <Card className='shadow-none '>
            ...
            <Dialog fullWidth open={EditModalOpen} maxWidth='md' scroll='body' sx={{ '& .MuiDialog-paper': { overflow: 'visible' } }}>
                ...
                <DialogTitle variant='h4' className='flex gap-2 flex-col text-center sm:pbs-16 sm:pbe-6 sm:pli-16'>
                    <Approve EditSelectedPost={EditSelectedPost} onsuccess={setEditModalOpen} getData={getusers} />
                </DialogTitle>
            </Dialog>
        </Card>
    )
